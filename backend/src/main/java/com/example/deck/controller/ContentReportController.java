...
public class ContentReportController {
    ...
    public ContentReportResponse reportPost(@PathVariable long postId,
        ...
        return ContentReportResponse.from(reportService.reportPost(postId, principal.getAccountId(), request));
    }
    ...
    public ContentReportResponse reportReply(@PathVariable long replyId,
        ...
        requirePrincipal(principal);
        response.setHeader("Cache-Control", "private, no-store");
        return ContentReportResponse.from(reportService.reportReply(replyId, principal.getAccountId(), request));
    }
